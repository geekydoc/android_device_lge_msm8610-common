...
$(SOMC_CFG_SENSORS_ACCEL_K3DH)-files += k3dh.c
...
$(SOMC_CFG_SENSORS_COMPASS_AK9911)-var-compass-ak9911 = yes
$(SOMC_CFG_SENSORS_COMPASS_AK9911)-cflags += -DAK9911 \
					     -DAKM_CHIP_NAME="\"AK991\"" \
					     -DAKM_CHIP_MAXRANGE=4900 \
					     -DAKM_CHIP_RESOLUTION=60 \
					     -DAKM_CHIP_POWER=0.4
...
$(yes-var-compass-ak9911)-files   += ak9911.c
...
$(SOMC_CFG_SENSORS_PROXIMITY_APDS9130)-files  += apds9130.c
$(SOMC_CFG_SENSORS_PROXIMITY_APDS9130)-cflags += -DPROXIMITY_SENSOR_NAME="\"APDS9130 Proximity\""
